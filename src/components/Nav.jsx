...
const Nav = () => {
    ...
    return (
         ...
         <div className="navbar bg-base-100 shadow-lg px-4 sm:px-8 right-0 left-0 fixed z-10 top-0 ">
  ...
  <div className="flex-none">
    <ul className="menu menu-horizontal flex md:gap-5 md:mr-8 px-1 font-bold">
     ...
     <label className="cursor-pointer grid place-items-center md:mr-3 sm:mr-0 ">
