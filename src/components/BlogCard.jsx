...
const BlogCard = ({blog}) => {
    ...
    return (
            ...
            <Link to={`/blogs/${id}`} className="max-w-sm border-2 transition border-primary hover:border-secondary hover:scale-105 border-opacity-30 mx-auto group hover:no-underline focus:no-underline dark:bg-gray-50">
