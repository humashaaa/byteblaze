...
const Blogs = () => {
    ...
    return (
        <section className="mt-4 dark:bg-gray-100 dark:text-gray-800">
	<div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
		...
		<div className="flex justify-center">
			<button type="button" className="px-6 py-3 text-sm rounded-md hover:underline dark:bg-gray-50 dark:text-gray-600" fdprocessedid="gp3j47">Load more posts...</button>
		</div>
	</div>
</section>
    );
